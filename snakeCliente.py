import pygame,random,socket,sys
...
def num_jugador(): #Seleccion de jugaadores para crear server
    global nJugadores
    start = False
    global screen
    screen.fill((0,0,0))
...
def continuar(puntaje): #Pantalla de final/Continuar
    global screen
    screen.fill((0,0,0))
    limites()
